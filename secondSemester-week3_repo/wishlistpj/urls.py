...
urlpatterns = [
    ...
    path('add_to_wishlist/<str:post_id>/', wishlistapp.views.add_to_wishlist, name = 'add_to_wishlist'),
    path('remove_from_wishlist/<str:post_id>/', wishlistapp.views.remove_from_wishlist, name = 'remove_from_wishlist'),
    path('bloglist', wishlistapp.views.bloglist, name = 'bloglist'), #과제

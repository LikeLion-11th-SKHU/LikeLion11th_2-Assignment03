...
urlpatterns = [
    ...
    path('add_from_wishlist/<int:post_id>', wishlistapp.views.remove_from_wishlist, name='remove_from_wishlist'),
   
    #과제
    path('collection/', wishlistapp.views.collection, name='collection'),
